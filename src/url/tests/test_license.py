...
def test_get_license_list():
    list_of_licenses = get_license_list(git_token)
...
def test_github_license():
    ...
    name_license = github_license("cloudinary", "cloudinary_npm", git_token, sample_approved_license_list)
    assert(name_license == "MIT License" or name_license == "mit license")
    
    name_license = github_license("PSOPT", "psopt", git_token, sample_approved_license_list)
    ...
    name_license = github_license("nullivex", "nodist", git_token, sample_approved_license_list)
    assert(name_license == "MIT License" or name_license == "mit license")
    
    name_license = github_license("apache", "airflow", git_token, sample_approved_license_list)
...
def test_search_readme():
    ...
    name = search_readme(api_Url, headers, git_token)
